  ...
  <main id="main">
            ...
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="./blogs/blog_1.php" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/finance_1.jpg');">
                      <div class="img-bg-inner">
                        <h2>Mastering Personal Finance. <br> (Your Path to Financial Freedom)</h2>
                        <p>Welcome to our personal finance blog, where we are dedicated to helping you take control of your finances and achieve financial freedom. In today's fast-paced world, managing money effectively has become increasingly crucial. Whether you're looking to pay off debt, save for retirement, or build wealth, our comprehensive guide will provide you with the knowledge and tools you need to succeed.</p>
                      </div>
                    </a>
                  </div>
                <div class="swiper-slide">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              <a href="./blogs/blog_2.php"><img src="assets/img/asset-1.jpg" alt="" class="img-fluid"></a>
              <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>June 5th '23</span></div>
              <h2><a href="./blogs/blog_2.php"> Adi Shankara:-<br>
                  Unraveling the Legacy of an Enlightened Philosopher and Theologian.</a></h2>
              <p class="mb-4 d-block">Adi Shankara, a prominent philosopher and theologian who lived in the 8th century CE, occupies a revered position in the annals of Indian history. His life and teachings continue to inspire and shape the spiritual fabric of the nation. In this article, we delve into the life, philosophy, and lasting impact of Adi Shankara, a trailblazing figure who revived Hindu philosophy and established the foundation of Advaita Vedanta.</p>

              <div class="d-flex align-items-center author">
                <div class="photo"><img src="assets/img/person-1.jpg" alt="" class="img-fluid"></div>
                <div class="name">
                  <h3 class="m-0 p-0">Cameron Williamson</h3>
                  <p>"I thoroughly enjoyed reading this insightful article on Adi Shankara. It provided a comprehensive overview of his life, teachings, and lasting impact on Hindu philosophy. Well-written and engaging!"</p>
                </div>
              </div>
            </div>
    ...
    <section class="category-section">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header d-flex justify-content-between align-items-center mb-5">
          <h2>Business</h2>
          <div><a href="category.php" class="more">See All Business</a></div>
        </div>
